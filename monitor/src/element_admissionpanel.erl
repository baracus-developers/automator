...
handle_event({system, powerprofile, _Operation, _Profile}) ->
    ...
    wf:flush();
handle_event({system, powernode, _Operation, _Profile}) ->
    ...
    Panel = #lightbox{ id="edit-node",
		       body=#panel{class="general-lightbox", 
				   body=[
					 ...
					 #flash{},
					 "Host: " ++ Mac,
					 #button{text="Cancel", postback=node_cancel_edit, delegate=?MODULE},
					 #button{text="Save", postback=node_save_edit, delegate=?MODULE}
					 ]
				  }
		     },
